...
pose_nein1 = poses["pose_nein1"]
pose_nein2 = poses["pose_nein2"]

neutral_pose = {name: 0.0 for name in joint_indices}

# NEIN
interpolate(neutral_pose, pose_nein1)
interpolate(pose_nein1, pose_nein2)
hold(pose_nein2)

# das
interpolate(pose_nein2, pose_sie)
hold(pose_sie)

# computer
interpolate(pose_sie, pose_computer)
hold(pose_computer)
